                ...
                <div className="lg:grid lg:grid-cols-12">
                    <div className="relative z-10 lg:col-start-1 lg:row-start-1 lg:col-span-4 lg:py-4 lg:bg-transparent">
                        ...
                        <div className="max-w-md mx-auto px-4 sm:max-w-3xl sm:px-6 lg:max-w-none lg:p-0">
                            <div className="aspect-w-10 aspect-h-6 sm:aspect-w-2 sm:aspect-h-1 lg:aspect-w-2">
                                <img className="lg:my-24 object-cover object-center rounded-3xl shadow-2xl" src={props.src} alt=""/>
                            </div>
                        </div>
                    </div>
                    <div className="relative bg-indigo-600 lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
                        ...
                        <div className="relative max-w-md mx-2 py-12 px-4 space-y-6 sm:max-w-3xl sm:py-8 md:py-20 lg:py-24 sm:px-6 lg:max-w-none lg:p-0 lg:col-start-4 lg:col-span-6">
                            <h2 className="text-4xl lg:text-5xl text-center font-extrabold text-white" id="join-heading">{props.title}</h2>
