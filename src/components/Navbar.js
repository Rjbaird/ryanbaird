...
const Navbar = ({ toggle }) => {
    return (
        <nav className ="flex bg-indigo-600 items-center justify-between px-3 py-2 relative">
            <div className="hover:animate-pulse">
                <Link to="/" className="h-8 text-white text-xl font-semibold">Ryan Baird</Link>
            </div>
